...
/* MAX_INT */
#define MAX_INT_0_DRIVEMODE CY_GPIO_DM_PULLUP_IN_OFF
#define MAX_INT_0_INBUF_ENABLED 0u
...
#define MAX_INT_DRIVEMODE CY_GPIO_DM_PULLUP_IN_OFF
#define MAX_INT_INBUF_ENABLED 0u
...
/* MAX_VIN */
#define MAX_VIN_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define MAX_VIN_0_INBUF_ENABLED 0u
#define MAX_VIN_0_INIT_DRIVESTATE 1u
#define MAX_VIN_0_INIT_MUXSEL 0u
#define MAX_VIN_0_INPUT_SYNC 2u
#define MAX_VIN_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define MAX_VIN_0_NUM 2u
#define MAX_VIN_0_PORT GPIO_PRT9
#define MAX_VIN_0_SLEWRATE CY_GPIO_SLEW_FAST
#define MAX_VIN_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define MAX_VIN_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define MAX_VIN_INBUF_ENABLED 0u
#define MAX_VIN_INIT_DRIVESTATE 1u
#define MAX_VIN_INIT_MUXSEL 0u
#define MAX_VIN_INPUT_SYNC 2u
#define MAX_VIN_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define MAX_VIN_NUM 2u
#define MAX_VIN_PORT GPIO_PRT9
#define MAX_VIN_SLEWRATE CY_GPIO_SLEW_FAST
#define MAX_VIN_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
...
/* MAX_GROUND */
#define MAX_GROUND_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define MAX_GROUND_0_INBUF_ENABLED 0u
#define MAX_GROUND_0_INIT_DRIVESTATE 0u
#define MAX_GROUND_0_INIT_MUXSEL 0u
#define MAX_GROUND_0_INPUT_SYNC 2u
#define MAX_GROUND_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define MAX_GROUND_0_NUM 4u
#define MAX_GROUND_0_PORT GPIO_PRT9
#define MAX_GROUND_0_SLEWRATE CY_GPIO_SLEW_FAST
#define MAX_GROUND_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define MAX_GROUND_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define MAX_GROUND_INBUF_ENABLED 0u
#define MAX_GROUND_INIT_DRIVESTATE 0u
#define MAX_GROUND_INIT_MUXSEL 0u
#define MAX_GROUND_INPUT_SYNC 2u
#define MAX_GROUND_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define MAX_GROUND_NUM 4u
#define MAX_GROUND_PORT GPIO_PRT9
#define MAX_GROUND_SLEWRATE CY_GPIO_SLEW_FAST
#define MAX_GROUND_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
